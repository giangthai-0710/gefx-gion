...
void SmallKnobLookAndFeel::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos, float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider)
{
...
void SmallKnobLookAndFeel::drawLabel(juce::Graphics& g, juce::Label& label)
{
}
